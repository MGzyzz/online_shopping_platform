...
urlpatterns = [
    ...
    path('shop/client/<int:shop_id>/edit/<int:product_id>/', EditProduct.as_view(), name='edit_product'),
    path('shop/client/<int:shop_id>/delete/<int:product_id>/', DeleteProduct.as_view(), name='delete_product')
]
